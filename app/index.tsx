        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.buttonContent}>
                    <MaterialCommunityIcons name="plus-circle-outline" size={40} color={Colors.lightpink} />
            ...
            >
                <View style={styles.buttonContent}>
                    <MaterialCommunityIcons name="folder-outline" size={40} color={Colors.lightpink} />
