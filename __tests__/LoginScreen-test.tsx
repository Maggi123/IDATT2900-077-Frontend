...
describe("When user is not authenticated yet", () => {
  beforeEach(() => {
  ...
  test("should render login button", () => {
    ...
    expect(screen.getByText("Login with External Account")).toBeOnTheScreen();
  });

  test("should call authorize on button press", async () => {
    render(<LoginScreen />);
...
describe("When user is authenticated", () => {
  ...
  test("should redirect to HomeScreen when user is authenticated and key is found in SecureStore", async () => {
  ...
  test("should clear session and throw error when SecureStore key is not found for authenticated user", async () => {
